...
/**
 * Auto-generate a question paper from concept_questions based on a difficulty×type distribution.
 * distribution example: { "easy": { "mcq": 5, "true_false": 3 }, "medium": { "mcq": 4 }, "hard": { "mcq": 2, "descriptive": 1 } }
 */
