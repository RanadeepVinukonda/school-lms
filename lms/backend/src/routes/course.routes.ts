...
router.post('/:courseId/enroll', authenticate, requireRole('student', 'admin'), validate(enrollStudentSchema), asyncHandler(courseController.enrollStudent));
router.post('/:courseId/unenroll', authenticate, validate(unenrollStudentSchema), asyncHandler(courseController.unenrollStudent));
