...
export const TYPED_TABLES: Record<string, Set<string>> = {
  ...
  textbooks: new Set(['id','title','subject_id','class_id','teacher_id','description','cover_image','storage_path','pdf_url','status','chapter_count','total_concepts','completed_concepts','failure_reason','logs','processing_stage','processing_progress','created_at','updated_at','data','school_id']),
  ...
  timetable: new Set(['id','class_id','day','period','subject_id','teacher_id','room','start_time','end_time','created_at','updated_at','status','archived_at','deleted_at','school_id']),
