...
export async function createAssignment(req: Request, res: Response) {
  ...
  logAudit(adminAuditEntry(req as any, 'assignmentV2.create' as AuditAction, result.id, 'assignmentV2', result.title, {
    newValue: result,
...
export async function releaseAssignment(req: Request, res: Response) {
  ...
  logAudit(adminAuditEntry(req as any, 'assignmentV2.release' as AuditAction, req.params.assignmentId, 'assignmentV2', old.title, {
...
export async function releaseGrades(req: Request, res: Response) {
  ...
  logAudit(adminAuditEntry(req as any, 'assignmentV2.update' as AuditAction, req.params.assignmentId, 'assignmentV2', old.title, {
...
export async function listForClass(req: Request, res: Response) {
  const result = await assignmentV2Service.listAssignmentsForClass(req.params.classId, req.query as any);
  sendSuccess(res, result);
}

export async function listForTeacher(req: Request, res: Response) {
  const result = await assignmentV2Service.listAssignmentsForTeacher(req.user!.uid, req.query as any);
  sendSuccess(res, result);
}
