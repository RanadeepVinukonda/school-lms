...
const PAGE_INDEX: PageEntry[] = [
  ...
  { id: 'teacher-coding', title: 'Coding Platform', keywords: ['coding', 'programming', 'code', 'teacher coding'], icon: 'code', url: ROUTES.TEACHER_CODING },
  { id: 'teacher-rewards', title: 'My Rewards', keywords: ['rewards', 'badges', 'achievements', 'xp'], icon: 'emoji_events', url: ROUTES.TEACHER_REWARDS },
  ...
  { id: 'welcome', title: 'Welcome', keywords: ['welcome', 'home', 'landing', 'start'], icon: 'home', url: ROUTES.WELCOME },
  { id: 'report-cards', title: 'Report Cards', keywords: ['report', 'report card', 'grades', 'marks', 'results', 'progress card'], icon: 'badge', url: ROUTES.PARENT_REPORTS },
  { id: 'student-reports', title: 'Student Reports', keywords: ['report', 'progress', 'performance', 'grades', 'marks'], icon: 'assessment', url: ROUTES.STUDENT_GAMIFICATION },
  { id: 'assignments', title: 'Assignments', keywords: ['assignments', 'homework', 'tasks', 'submissions'], icon: 'assignment', url: ROUTES.STUDENT_TASKS },
  { id: 'student-labs', title: 'Virtual Labs', keywords: ['lab', 'virtual lab', 'experiment', 'simulation'], icon: 'science', url: ROUTES.STUDENT_LABS },
  { id: 'roll-number', title: 'Roll Number Entry', keywords: ['roll number', 'roll no', 'registration'], icon: 'pin', url: ROUTES.STUDENT_ROLL_NUMBER },
  { id: 'admin-profile-edit', title: 'Edit Profile (Admin)', keywords: ['edit profile', 'admin profile', 'my account'], icon: 'manage_accounts', url: '/admin/profile/edit' },
  { id: 'teacher-select-class', title: 'Select Class', keywords: ['select class', 'choose class', 'class selection'], icon: 'playlist_add_check', url: '/teacher/select-class' },
