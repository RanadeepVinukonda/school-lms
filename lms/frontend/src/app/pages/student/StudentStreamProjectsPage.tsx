...
export default function StudentStreamProjectsPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-6 space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-on-surface">STREAM Projects</h1>
        <p className="text-on-surface-variant mt-1">Cross-subject collaborative projects integrating Science, Technology, Robotics, Engineering, Arts, and Mathematics</p>
      </div>
      ...
      {loading ? (
        ...
        <div className="text-center py-16">
          ...
          <p className="text-on-surface-variant mt-4">No STREAM projects available yet</p>
          <p className="text-label-sm text-on-surface-variant/60 mt-1">Check back soon for new projects</p>
        </div>
      ) : (
        <div className="grid grid-cols-1 md:grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
