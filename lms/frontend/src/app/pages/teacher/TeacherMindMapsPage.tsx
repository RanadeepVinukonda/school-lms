...
export default function TeacherMindMapsPage() {
  ...
  return (
    <>
      <SEOHead title={_('Mind Maps')} description={_('Create and manage mind maps')} />
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        exit={{ opacity: 0 }}
        ...
        <motion.div variants={scrollReveal} initial="hidden" whileInView="show" viewport={{ once: true, margin: '-60px' }}>
          <div className="flex items-center justify-between flex-wrap gap-4">
            <div>
              ...
              <p className="text-body-md text-muted-foreground">{_('Create revision maps, pin resources, and view shared maps from students')}</p>
            </div>
            ...
            <Card className="border-border/60">
              <CardContent className="p-12 text-center space-y-4">
                ...
                <div>
                  ...
                  <p className="text-body-sm text-muted-foreground">{_('Create your first mind map to start organizing resources')}</p>
                </div>
