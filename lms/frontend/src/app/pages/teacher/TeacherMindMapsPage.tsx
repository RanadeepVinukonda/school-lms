...
export default function TeacherMindMapsPage() {
  ...
  return (
    <>
      <SEOHead title="Mind Maps" description="Create and manage mind maps" />
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        exit={{ opacity: 0 }}
      ...
      >
        <motion.div variants={scrollReveal} initial="hidden" whileInView="show" viewport={{ once: true, margin: '-60px' }}>
          <div className="flex items-center justify-between flex-wrap gap-4">
            <div>
              <h1 className="text-headline-sm md:text-headline-md font-bold tracking-tight">Mind Maps</h1>
              <p className="text-body-md text-muted-foreground">Create revision maps, pin resources, and view shared maps from students</p>
            </div>
          ...
          {(data) => data && data.length > 0 ? (
                      ...
                      <CardContent className="p-6">
                        <div className="flex items-start gap-4">
                          ...
                          <div className="min-w-0 flex-1">
                            ...
                            {map.description && <p className="text-xs text-muted-foreground mt-1 line-clamp-2">{map.description}</p>}
                          </div>
                        </div>
                      </CardContent>
            ...
            <Card className="border-border/60">
              <CardContent className="p-12 text-center space-y-4">
                ...
                <div>
                  <p className="text-title-md font-bold">No mind maps yet</p>
                  <p className="text-body-sm text-muted-foreground">Create your first mind map to start organizing resources</p>
                </div>
        ...
        {sharedMaps && sharedMaps.length > 0 && (
          <div className="space-y-4">
            <h2 className="text-title-md font-bold tracking-tight">Shared with Me</h2>
