    ...
    <>
      ...
      <motion.div variants={pageTransition} initial="initial" animate="animate" exit="exit" className="p-4 max-w-4xl mx-auto space-y-6 pb-20">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Push assessment results to students</p>
        </div>

        <Card>
          <CardHeader><CardTitle className="text-sm">Step 1: Select Class</CardTitle></CardHeader>
          <CardContent>
            <select
        ...
        {selectedClassId && (
          <Card>
            <CardHeader><CardTitle className="text-sm">Step 2: Select Scope</CardTitle></CardHeader>
          ...
          <Card className="border-amber-200 dark:border-amber-800">
            <CardContent className="p-4 space-y-3">
              <div className="flex items-center gap-2 text-amber-600 dark:text-amber-400">
                ...
                <p className="text-sm font-medium">Ready to release</p>
              </div>
        ...
        {!selectedClassId && (
          <Card>
            <CardContent className="p-8 text-center text-muted-foreground">
              ...
              <p>Select a class to release grades</p>
            </CardContent>
          </Card>
        )}
