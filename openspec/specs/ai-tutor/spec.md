...
## Purpose
Provide students with an intelligent AI-powered tutoring assistant that answers questions contextually, supports bilingual interaction, and adapts to the student's current learning context.
