...
## Purpose
Enable teachers to upload textbook pages (photo or PDF) and automatically extract text, detect concepts, and generate assessment questions across multiple difficulty levels and question types.
