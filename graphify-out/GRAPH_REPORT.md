...
Cohesion: 0.10
Nodes (32): ThemeToggle(), UserAvatar(), AdminLayout(), NavItem, navItems, StudentLayout(), mobileNavItems, NavGroup (+24 more)
...
Cohesion: 0.11
Nodes (26): SearchData, formatTime(), AssignmentItem, ExamItem, LessonItem, QuizItem, ExamWithSubject, buildTasks() (+18 more)
...
Cohesion: 0.07
Nodes (32): createAssignment(), getAssignment(), gradeSubmission(), listAllAssignments(), listAssignmentsByCourse(), listSubmissions(), submitAssignment(), updateAssignment() (+24 more)

### Community 23 - "Community 23"
Cohesion: 0.06
Nodes (52): deleteAssignment(), createCourse(), deleteCourse(), enrollStudent(), getCourse(), getEnrollments(), listCourses(), unenrollStudent() (+44 more)
...
Cohesion: 0.08
Nodes (30): addStudents(), createClass(), deleteClass(), getClass(), getRoster(), listClasses(), removeStudents(), updateClass() (+22 more)
...
Cohesion: 0.13
Nodes (8): LoadingSkeletonProps, ClassSelectionPage(), SubjectWithClassId, TCSAssignment, TeacherAssignment, TeacherTextbookUploadPage(), Skeleton(), SkeletonProps
...
Cohesion: 0.13
Nodes (17): extractTextFromPDF(), createEnrollment(), getStudentsByClass(), createTextbook(), saveChapters(), searchVideosForConcept(), YouTubeVideo, runProcessing() (+9 more)
...
Cohesion: 0.13
Nodes (13): api, assignmentService, PaginatedItems, authService, settingsService, SystemSettings, TeacherClassSubject, teacherClassSubjectService (+5 more)

### Community 69 - "Community 69"
Cohesion: 0.23
Nodes (14): getAllGrades(), getAssignmentsBySubject(), getExamsBySubject(), countArrayQuery(), countQuery(), DependencyCategory, getAssignmentDependencies(), getCourseDependencies() (+6 more)
...
Cohesion: 0.16
Nodes (13): steps, TutorialGuide(), TutorialGuideProps, db, firebaseConfig, storage, NavItem, navItems (+5 more)

### Community 73 - "Community 73"
Cohesion: 0.17
Nodes (15): Assignment, AssignmentStatus, Grade, GradeLevel, RubricCriteria, Submission, SubmissionStatus, Class (+7 more)

### Community 76 - "Community 76"
Cohesion: 0.14
Nodes (10): ACTION_COLORS, AuditLog, Pagination, RouteErrorFallback(), ForgotPasswordForm(), LoginForm(), RegisterForm(), ResetPasswordForm() (+2 more)
...
Cohesion: 0.09
Nodes (20): getBucket(), buildPrompt(), Difficulty, ensureAllTypes(), LLMChapter, LLMConcept, LLMQuestion, LLMResponse (+12 more)
...
Cohesion: 0.06
Nodes (36): AdminLoginPage(), StudentLoginFormData, StudentLoginPage(), studentLoginSchema, TeacherLoginFormData, TeacherLoginPage(), teacherLoginSchema, loginUser() (+28 more)
...
Cohesion: 0.12
Nodes (18): chat(), listAuditLogs(), recoverEntity(), changePassword(), forgotPassword(), getProfile(), login(), register() (+10 more)
...
Cohesion: 0.09
Nodes (24): allowedOrigins, corsOptions, envSchema, parsed, getWhiteboard(), saveWhiteboard(), getMyEnrollments(), getCollection() (+16 more)
...
Cohesion: 0.20
Nodes (14): courseService, lessonService, Course, CourseFilters, CourseLevel, CourseStatus, Enrollment, EnrollmentStatus (+6 more)
...
Cohesion: 0.07
Nodes (16): formatDate(), formatDateTime(), formatPercentage(), formatRelativeTime(), getLetterGrade(), STATUS, submitSchema, teacherNotes (+8 more)

### Community 403 - "Community 403"
Cohesion: 0.13
Nodes (10): PAGINATION, ROLE_HIERARCHY, UPLOAD, ProtectedRoute(), roleDashboard(), canViewAnalytics(), checkPermission(), isTeacher() (+2 more)
